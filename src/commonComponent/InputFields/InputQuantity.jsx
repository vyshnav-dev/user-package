...
useEffect(() => {
        ...
        if (
          ...
          ? new Intl.NumberFormat(
            "en-US",
            {
              ...
              minimumFractionDigits: fractionDigits > 0 ? fractionDigits : FixedValues.DisplayDecimals,
   ...
   if (newValue !== null && RoundOff != null && !isNaN(RoundOff) && RoundType) {
    ...
    if (roundedValue !== newValue) {
      ...
      if (
        ...
        const maxFractionDigits =  RegularExpression ?getMaxFractionDigitsFromRegex(regexString):null;
        const fractionDigits = DecimalPoints ?? maxFractionDigits;  // NEW
        setValue({ name, value: newValue?? null });
  ...
  return (
    <CustomTextField
      ...
      sx={{
        minWidth: tableField ? "100%" : width + ColumnSpan * 50, // Adjust the width as needed
